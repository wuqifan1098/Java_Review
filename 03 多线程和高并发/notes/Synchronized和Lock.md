...
# 四.不使用Synchronized和ReentrantLock，如何实现一个线程安全的单例模式？
...
从反编译获得的字节码可以看出，synchronized代码块实际上多了monitorenter和monitorexit两条指令。monitorenter指令执行时会让对象的锁计数加1，而monitorexit指令执行时会让对象的锁计数减1。

## 3.同步一个类

## 4.同步静态方法

# 五.synchronized怎么升级成重量级锁
...
作者：EnjoyMoving链接：https://www.zhihu.com/question/53826114/answer/236363126来源：知乎著作权归作者所有。商业转载请联系作者获得授权，非商业转载请注明出处。
